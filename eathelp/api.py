...
api.add_resource(UserItem, "/chefs/<int:chef>")     # "/chefs/<string:chef>"
api.add_resource(CookbookCollection, "/chefs/<int:chef>/cookbooks/", "/cookbooks/")     # "/chefs/<string:chef>"
api.add_resource(CookbookItem, "/chefs/<int:chef>/cookbooks/<int:cookbook>")    # "/chefs/<string:chef>"
